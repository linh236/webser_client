     ...
     <Modal show={show} onHide={handleClose}>
      ...
      <table className="table">
        ...
        <tr>
          ...
          <td className="text-center border"><Button color="primary" className={item0.status==='on'? 'bg-danger text-white led_status0' : 'led_status0'} variant="outlined"  onClick={(e)=>Turn_led(item0.status, 'led_status0', 'status')}>{item0.status}</Button></td>
        ...
        <tr>
          ...
          <td className="text-center border"><Button color="primary"  className={item1.status==='on'? 'bg-danger text-white led_status1' : 'led_status1'} variant="outlined"  onClick={(e)=>Turn_led(item1.status, 'led_status1', 'status')}>{item1.status}</Button></td>
        ...
        <tr>
          ...
          <td className="text-center border"><Button color="primary"  className={item2.status==='on'? 'bg-danger text-white led_status2' : 'led_status2'} variant="outlined"  onClick={(e)=>Turn_led(item2.status, 'led_status2', 'status')}>{item2.status}</Button></td>
        ...
        <tr>
          ...
          <td className="text-center border"><Button color="primary"  className={item3.status==='on'? 'bg-danger text-white led_status3' : 'led_status3'} variant="outlined"  onClick={(e)=>Turn_led(item3.status, 'led_status3', 'status')}>{item3.status}</Button></td>
        ...
        <tr>
          ...
          <td className="text-center border"><Button color="primary"  className={item5.status==='on'? 'bg-danger text-white led_status5' : 'led_status5'} variant="outlined"  onClick={(e)=>Turn_led(item5.status, 'led_status5', 'status')}>{item5.status}</Button></td>
        ...
        <tr>
          ...
          <td className="text-center border"><Button color="primary"  className={item6.status==='on'? 'bg-danger text-white led_status6' : 'led_status6'} variant="outlined"  onClick={(e)=>Turn_led(item6.status, 'led_status6', 'status')}>{item6.status}</Button></td>
        ...
        <tr>
          ...
          <td className="text-center border"><Button color="primary"  className={item7.status==='on'? 'bg-danger text-white led_status7' : 'led_status7'} variant="outlined"  onClick={(e)=>Turn_led(item7.status, 'led_status7', 'status')}>{item7.status}</Button></td>
        ...
        <tr>
          ...
          <td className="text-center border"><Button color="primary"  className={item8.status==='on'? 'bg-danger text-white led_status8' : 'led_status8'} variant="outlined"  onClick={(e)=>Turn_led(item8.status, 'led_status8', 'status')}>{item8.status}</Button></td>
          <td className="text-center border"><Button color="primary" variant="outlined"  onClick={(e)=>setTime(item8.status, 'led_status8', 'turnon')}>{item8.turnon}</Button></td>
